      ...
      <div className="bg-white rounded-xl shadow-sm border border-gray-200 overflow-hidden">
        <div className="px-4 py-3 sm:px-6 sm:py-4 border-b border-gray-100 bg-gradient-to-r from-gray-50 to-white">
          ...
          <p className="text-xs sm:text-sm text-gray-500 mt-1">
            Precios base para calcular la cantidad de cortes.
          </p>
        </div>

        {error && (
          <div className="mx-4 mt-4 sm:mx-6 sm:mt-4 p-3 bg-red-50 border border-red-100 rounded-lg">
            <p className="text-xs sm:text-sm text-red-700">{error}</p>
          </div>
        )}

        {success && (
          <div className="mx-4 mt-4 sm:mx-6 sm:mt-4 p-3 bg-green-50 border border-green-100 rounded-lg">
        ...
        <div className="overflow-x-auto">
          <table className="w-full">
            <thead className="bg-gray-50">
              <tr>
                <th className="text-left px-3 py-2 sm:px-6 sm:py-3 text-xs font-semibold text-gray-500 uppercase tracking-wider">
                  Servicio
                </th>
                <th className="text-left px-3 py-2 sm:px-6 sm:py-3 text-xs font-semibold text-gray-500 uppercase tracking-wider">
                  Precio
                </th>
                <th className="text-right px-3 py-2 sm:px-6 sm:py-3 text-xs font-semibold text-gray-500 uppercase tracking-wider">
                  Acciones
                </th>
              </tr>
            </thead>
                    ...
                    {editingService === service.serviceName ? (
                      <div className="flex items-center gap-1 sm:gap-2">
                        ...
                        <input
                          ...
                          className="w-20 sm:w-28 px-2 py-1.5 sm:px-3 sm:py-1.5 border border-gray-200 rounded-lg text-xs sm:text-sm focus:outline-none focus:border-gray-900 focus:ring-1 focus:ring-gray-900"
                          min="0"
                          autoFocus
                        />
                      </div>
                      ...
                      {editingService === service.serviceName ? (
                        <>
                          <button
                            ...
                            className="px-2.5 py-1 sm:px-3 sm:py-1.5 bg-green-50 hover:bg-green-100 text-green-700 rounded-lg text-xs sm:text-sm font-medium transition-colors cursor-pointer"
                          >
                            ✓
                          </button>
                          <button
                            onClick={cancelEdit}
                            className="px-2.5 py-1 sm:px-3 sm:py-1.5 bg-gray-100 hover:bg-gray-200 text-gray-700 rounded-lg text-xs sm:text-sm font-medium transition-colors cursor-pointer"
                          >
                            ✕
                          </button>
                        </>
                        ...
                        <>
                          ...
                          <button
                            ...
                            className="px-2.5 py-1 sm:px-3 sm:py-1.5 bg-gray-100 hover:bg-red-50 text-gray-700 hover:text-red-600 rounded-lg text-xs sm:text-sm font-medium transition-colors cursor-pointer"
        ...
        <div className="px-4 py-3 sm:px-6 sm:py-4 border-t border-gray-100 bg-gray-50">
          {showAddForm ? (
            <div className="flex flex-col sm:flex-row gap-2 sm:gap-3 items-end">
              <div className="flex-1 w-full sm:min-w-[150px]">
                ...
                <input
                  ...
                  className="w-full px-3 py-2 border border-gray-200 rounded-lg text-xs sm:text-sm focus:outline-none focus:border-gray-900 focus:ring-1 focus:ring-gray-900"
                />
              </div>
              ...
              <button
                ...
                className="w-full sm:w-auto px-4 py-2 bg-gray-200 hover:bg-gray-300 text-gray-700 rounded-lg text-xs sm:text-sm font-medium transition-colors cursor-pointer"
              >
                Cancelar
              </button>
            </div>
            ...
            <button
              ...
              className="inline-flex items-center gap-2 px-3 py-2 sm:px-4 sm:py-2 bg-gray-100 hover:bg-gray-200 text-gray-700 rounded-lg text-xs sm:text-sm font-medium transition-colors cursor-pointer"
            >
